...
class Wenku8ToEpub:
    ...
    def bookinfo(self, book_id: int):
        ...
        # soup_cat = Soup(resp)
        soup_cat = Soup(requests.get(url_cat, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36'}).content, 'html.parser')
